...
<body class="container mt-5">
  ...
  <li class="nav-item">
    <a class="nav-link active d-inline" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Contact Details</a>
    <div class="mt-3">
